  ...
  return (
    <View style={[styles.fill, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        {query.length === 0 ? (
          <>
            <Text style={[typography.title3, { color: colors.text, marginTop: 22, marginBottom: 10 }]}>
              Categories
            </Text>
          ...
          <>
            <Text style={[typography.subhead, { color: colors.textSecondary, marginTop: 16, marginBottom: 8 }]}>
